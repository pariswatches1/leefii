...
// New states with their cities
const newStatesWithCities = [
  {
    state: { name: 'New Jersey', abbreviation: 'NJ', slug: 'new-jersey', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Maryland', abbreviation: 'MD', slug: 'maryland', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Missouri', abbreviation: 'MO', slug: 'missouri', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Ohio', abbreviation: 'OH', slug: 'ohio', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Pennsylvania', abbreviation: 'PA', slug: 'pennsylvania', isRecreational: false, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Connecticut', abbreviation: 'CT', slug: 'connecticut', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Maine', abbreviation: 'ME', slug: 'maine', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Vermont', abbreviation: 'VT', slug: 'vermont', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'New Mexico', abbreviation: 'NM', slug: 'new-mexico', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Montana', abbreviation: 'MT', slug: 'montana', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Alaska', abbreviation: 'AK', slug: 'alaska', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Rhode Island', abbreviation: 'RI', slug: 'rhode-island', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Delaware', abbreviation: 'DE', slug: 'delaware', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Minnesota', abbreviation: 'MN', slug: 'minnesota', isRecreational: true, isMedical: true },
    cities: [
  ...
  {
    state: { name: 'Virginia', abbreviation: 'VA', slug: 'virginia', isRecreational: false, isMedical: true },
    cities: [
      ...
      { name: 'Arlington', slug: 'arlington', latitude: 38.8816, longitude: -77.0910 },
    ]
  },
];
