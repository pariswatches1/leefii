    ...
    <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition relative flex flex-col h-full">
      ...
      <div className="flex gap-2 mt-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium rounded-lg transition ${
            dispensary.website
              ? 'flex-1 border-2 border-green-600 text-green-600 hover:bg-green-50'
